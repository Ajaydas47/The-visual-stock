...
from .features import website_open
...
from .features import google_calendar
from .features import note
from .features import system_stats
...
class AlphaAssistant:
    ...
    def website_opener(self, domain):
        """
        This will open the website according to the domain
